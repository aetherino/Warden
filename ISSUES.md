...
## Status: Dev (foundation complete). Rubric §11 (open inference) + SOURCES.md + frontend-design skill on master. Next: scaffold the Python harness (P0 keys block) + golden set.
